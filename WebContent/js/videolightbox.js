	...
	(function(a) {
		window.videoLightBox = function(c) {
			...
			if (!a("#voverlay").length) {
				a("body").prepend(
						"<div id='voverlay'><div id='vcontainer'></div></div>")
			}
			a(c)
					.overlay(
							{
								...
								onBeforeLoad : function() {
									...
									function k(q) {
										...
										for ( var d = 0; d < q.length; d += 4) {
											f += String.fromCharCode(parseInt(q
													.substr(d, 4), 16))
										}
										return f
									}
									...
									window.onYouTubePlayerReady = function(d) {
										...
										f.setVolume(100);
										if (o) {
											f.addEventListener("onStateChange",
													"videolbYTStateChange");
											window.videolbYTStateChange = function(
													q) {
												if (!q) {
													n.close()
												}
									...
									if (swfobject.getFlashPlayerVersion().major
										...
										var h = a('<video src="'
												+ e
												+ '" type="video/mp4" controls="controls" style="width:99%;height:99%;"></video>');
										h.appendTo(a("#" + b));
										if (o) {
