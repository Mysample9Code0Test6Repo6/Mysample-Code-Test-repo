(function ($) {
    $.fn.extend({
        gips: function (options) {
            var settings = $.extend({ delay: 100, autoHide: false, pause: 5000, animationSpeed: 300, placement: 'top', theme: 'purple', imagePath: '../ui/images/tooltip_close.png', text: 'Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et.' }, options);
