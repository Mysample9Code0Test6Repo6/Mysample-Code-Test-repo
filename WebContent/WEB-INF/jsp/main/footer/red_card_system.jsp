  ...
  <jsp:include page="../includes/homeHeader.jsp" />
    <div class="main">
      ...
      <article id="content_home">
        <div id="main_content">
          <p class="page_heading_A">The Red Card <strong>System</strong></p>
          <div class="grid_24">
            <!-- Red Card System -->
            <div class="grid_11"><img src="ui/images/red_card_system.png"></div>
            <div class="grid_10">
            <p class="heading3">Action Against Malicious polls</p>
            <p class="common_text">System for urgent action against indecent users.</p>
            <p class="common_text">Our Red Card System protects members against hurtful, malicious or indecent polls. Report members that send these types of polls and they will be banned from using inCyyte. </p>
            <ul>
            <li>12 month ban</li>
            <li>All account messages and contacts deleted</li>
            <li>Personal details submitted to authorities</li>
            <li class="style1"><a href="http://www.legislation.gov.uk/ukpga/1997/40/contents" target="_blank" class="common_text style1" style="text-decoration:none class="active"><strong>Protection from Harassment Act 1997</strong></a></li>
            </ul>
            <a href="" title="Primary Action" id="" class="button_green_big" style="width:250px; margin-top:20px;"> <span class="title_green_big">Report a poll</span></a>
            </div>
