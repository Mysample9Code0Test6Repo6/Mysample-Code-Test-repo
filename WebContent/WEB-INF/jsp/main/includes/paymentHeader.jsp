...
<div class="header36" >
    <div id="headerinner" >
        <div id="logocontainer"><a href="javascript:void(0)"  id="logo_inner">inCyyte</a></div>
        <div id="header_topnav_inner">
            <ul id="header_topmenu">

                <!-- User settings starts Here -->
                <li id="usersettingContainer" class="last">
        ...
        <div id="welcome_user">
            <div id="userphoto">
                ...
                <%}else{ %>
                <img src="${user.profilePicture}" width="24" height="24" alt="User Photo" />
                <%}%>
            </div>
