...
<div id="gradient">
      ...
      <article id="content">
        <div id="main_content">
          <div class="error_wrapper">
            <!----- Error Msg ----->
            <br>
            <h1 align="left" class="style1"><img src="${pageContext.request.contextPath}/ui/images/incyyte-error-icon.png" width="26" height="26"> Oops!.. This invitation has already expired.</h1>
            ...
            <p align="left" class="style2" >&nbsp;</p>   
            <p align="left" class="style2" >&nbsp;</p>         
            <p align="left" class="style2" >Please click this <a href="${pageContext.request.contextPath}/welcome.cyt" target="_self" class="style3">link </a>to return to the Home page</p>
            <!----- Error Msg ----->
          </div>
        </div>
      </article>
  ...
  <footer class="footer_inner">
      ...
      %>
      <div style=" text-align:center;color:white; "> &copy; inCyyte <%=strFooterDate%> all rights reserved   </div>
  </footer>
</div>
<!--footer end-->
