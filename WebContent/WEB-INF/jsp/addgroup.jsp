	...
	<body>
		...
		<jsp:include page="include/header.jsp" />
    		...
    		<div id="container">
				...
				<div class="header">
		 	 		CREATE AN INCYYTE GROUP
				</div>
				<form:form  id="addGroupForm"  modelAttribute="group" method="post" commandName="group" enctype="multipart/form-data">   
		              		...
		              		<div class="mainPanelBody">
            					...
            					<div class="panelTable">
			                   		...
			                   		<div class="row">
			                     		...
			                     		<font color="red"><form:errors path="postCode" cssClass="error" /></font>
				                   	...
				                   	<input type="hidden" name="existgrpnames" id="exists" value="${userGroupNames}" />             
						         	<div class="row">
				                   		<div class="labelCell2 loginText">
            					...
            					<div class="panelTable">
	            					<div class="row">
				                     	...
				                     	<div class="labelCell2 loginText">
				                       			...
				                       			<label> Choose contacts as admin role :</label>
				                     	</div>
            						...
            						<div class="row">
				                     	...
				                     	<div class="contentCell2">
				                       		<input type="button" value="Create Group" onclick="selValues('<c:url value='addgroup.cyt' />');"/>
				                       	</div>
				                   	</div> 
