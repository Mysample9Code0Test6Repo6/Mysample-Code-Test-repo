   	...
   	<div class="centerPane">        
        ...
        <div class="cpTop">                
            ...
            <div class="bgBody">
                      <p class="panelFont">
                      <%
                      	String url = "/addcomment.cyt";
                      %>
`                     
                     	  <c:forEach items="${questions}" var="question" varStatus="rowItem">
                     	  <form:form id="addCommentForm" action="addcomment.cyt" modelAttribute="forum" method="post">
                     	  ${ question.question} <br/>
                       &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                       <form:textarea  path="comment" cols="50" rows="2" style="overflow:hidden; width: 400px; font-size: 15px;
                         vertical-align: middle" class="name" title="Post your coment here" ></form:textarea>
                         <input type="hidden" name="questionId" value="${ question.questionId }" />
                      		 <input name="send2" type="submit" value="Post" style="width:65px; height:40px; vertical-align:middle" id="send2"/>
                      		  </form:form>
                      	 </c:forEach>																								
