...
<script language="JavaScript"
	src="${pageContext.request.contextPath}/ui/modal/colorbox/jquery.colorbox.js"></script>


<script language="JavaScript"
	src="${pageContext.request.contextPath}/ui/js/modelLogin.js"></script>
...
<script language="JavaScript" type="text/javascript"
	src="${pageContext.request.contextPath}/ui/js/jquery-ui.js"></script>
<script language="JavaScript" type="text/javascript"
	src="${pageContext.request.contextPath}/ui/js/jquery.lightbox-0.5.js"></script>
<script language="JavaScript" type="text/javascript"
	src="${pageContext.request.contextPath}/ui/js/validate/jquery.validate.js"></script>
<script
	src="${pageContext.request.contextPath}/ui/js/jquery.selectbox-0.2.js"></script>
<script type="text/javascript">
	$(function() {
		$("select").selectbox();
	});
...
<script language="JavaScript"
	src="${pageContext.request.contextPath}/ui/js/prettyCheckboxes.js"
	type="text/javascript" charset="utf-8"></script>
<script type="text/javascript"
	src="${pageContext.request.contextPath}/ui/js/jquery.orbit.js"></script>
...
function submitLoginForm(){
   ...
   function callSignup(){
    ...
    function callModalSignup(){
        ...
        if ( userSignupValid && emailSignupValid && passwordValid && genderValid) {
            submitSignUpForm();
        }
    }
...
function submitSignUpForm() {
	...
	} else if(loginFrom == "viewUserPollPage"){		
		 var contextVar = document.getElementById("contextPathVar").value;
		  $("#signup_modal_big").ajaxSubmit({
		        type:'POST',
		        url:contextVar+'/createAcctPollPagecreateAcctPollPage.cyt',
		        success:function (data) {
 ...
 <input type="hidden" id="contextPathVar" value="${pageContext.request.contextPath}">
	...
	<div style="display: none;">
		<form:form id="create_signupform" commandName="signUpForm" method="post">
			<p class="heading1">
				Sign up today, it's <a href="javascript:void(0)"
					style="color: #ed1c24; cursor: none;"> FREE!</a>
			</p>
			<form:input path="username" id="username"
				placeholder="Username" onFocus="this.placeholder = ''"
				 onBlur="this.placeholder = 'Username'" onKeyUp="UserVal()" onKeydown="Javascript: if (event.keyCode==13 ) callSignup();" />
			...
			<form:input path="su_email" id="su_email" placeholder="Email"
				onFocus="this.placeholder = ''"
             	onBlur="this.placeholder = 'Email'" onkeyup="SignupEmail()"  onKeydown="Javascript: if (event.keyCode==13 ) callSignup();" />
			...
			<div id="login_wrapper">
				<form:password path="su_password" id="pollSignupPassword"
					...
					onBlur="this.placeholder = 'Password'" onkeyup="SignupModalPass()" onKeydown="Javascript: if (event.keyCode==13 ) callSignup();" />
	...
	<!--------New SignUp Modal Big ----------->
	 <div style="display: none;">
		<form:form id="signup_modal_big" commandName="signUpForm" method="post">
			...
			<form:input type="text" id="usernamePollPageSignUp"  path="username" placeholder="UserName" onFocus="this.placeholder = ''" onBlur="this.placeholder = 'UserName'" onkeyup="ModalUservalidate()" onKeydown="Javascript: if (event.keyCode==13 ) callModalSignup();" />
			<div id="user_inavalid" style="display: none; color: #C2002D;font-size:15px;margin-left: 5px;"></div>
			<form:input type="text" id="emailPollPageSignUp" path="su_email"  placeholder="Email" onFocus="this.placeholder = ''" onBlur="this.placeholder = 'Email'" onkeyup="ModalEmailValidate()"  onKeydown="Javascript: if (event.keyCode==13 ) callModalSignup();" />
			<div id="email_invalid" style="display: none; color: #C2002D;font-size:15px;margin-left: 5px;"></div>
			<form:input type="password"  id="passwordPollPageSignUp" path=""  placeholder="Enter your password"  onFocus="this.placeholder = ''"	onBlur="this.placeholder = 'Enter your password'" onkeyup="ModalPassValidate()" onKeydown="Javascript: if (event.keyCode==13 ) callModalSignup();" />
			<div id="password_invalid" style="display: none; color: #C2002D;font-size:15px;margin-left: 5px;"></div>
			<br>
			<br>
			<br>
			...
			<div class="button_wrap" style="margin-top: 20px;">
				<input type="button" onclick="javascript:callModalSignup();" class="new_button" value="SIGN UP NOW" />
			</div>
