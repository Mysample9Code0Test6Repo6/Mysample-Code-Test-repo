      	...
      	<div class="centerPane">        
        	...
        	<div class="cpTop">                
            	...
            	<div class="bgBody">
            		<form:form id="sendInCyyteForm" commandName="sendInCyyteForm"  method="post">
	                	...
	                	<p class="panelFont"> New Question :
	                    	<form:textarea path="incyyte" cols="50" rows="2" style="overflow:hidden; width: 400px; font-size: 15px; vertical-align: middle" cssClass="name" id="question" title="Type your question here" />
	                      	...
	                      	<input name="create_send" type="button" value="Send" style="width:70px; height:40px; vertical-align:middle" id="create_send"/>
	                 	</p>
                 	</form:form>            
            		<div class="quControlBar"> 
						...
						<span class="linkSpacer"></span> | <span class="linkSpacer"></span>                                 
                        <span class="panelLink" title="select inCyyte group" id="groupLabel">select Group</span>
						<span class="linkSpacer"></span> | <span class="linkSpacer"></span>                 
        	...
        	<div class="cpView">    
        		<c:choose>
	            	...
	            	<c:when test="${questionCode != null}">
	            		<div class="question"></div>
	            		<div class="pieChart">
	            			<jsp:include page="include/sampleChart.jsp" />
	            		</div>            		
	            	</c:when>
	            	<c:when test="${generalChartCode != null}">
	           			<div class="question"></div>
	            		<div class="pieChart">
	            			<jsp:include page="include/generalInCyyteChart.jsp" />
	            		</div>
	            	</c:when>
	            	<c:otherwise>
	            		<div class="question"></div>
	            		<div class="pieChart">
	            			<jsp:include page="include/homeChart.jsp" />
	            		</div>           			
	           		</c:otherwise>
            	</c:choose> 
        	</div>  
            	...
            	<div class="bgBody">
                	<p class="panelFont">
                       &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <textarea name="textfield" cols="50" rows="2" style="overflow:hidden; width: 400px; font-size: 15px;
                         vertical-align: middle" class="name" id="comment" title="Post your coment here" ></textarea>
	        	...
	        	<div class="content">
		       		<div id="noticeboardPortlet">
		          		<div class="card"></div>
		               	<div class="details">
	                       		<ul>
	                                <c:forEach var="myInCyyte" items="${myInCyytes}">
	                                	<li><a href="home.cyt?code=${myInCyyte.incyyte.incyyteCode}"><b>0%</b>${myInCyyte.question}</a></li>
	                                </c:forEach>
	                                <li><a href="http://www.panamedia.co.uk/cyytehp/incyyte/index1.html" target="_blank">more..</a>.</li>
	                           	</ul>
		              	</div>
		            </div>   			
	        	</div>
	        	...
	        	<div class="content">
	           		<div id="noticeboardPortlet">
	                	<div class="card"></div>
	                   	<div class="details">
	                        	<ul>
	                                <c:forEach var="inCyyteResult" items="${inCyyteResults}">                                
	                                	<li><a  href="home.cyt?code=${inCyyteResult.incyyte.incyyteCode}" >
	                                		<b>0%</b>${inCyyteResult.question}</a>
	                                	</li>
	                                </c:forEach>
	                                <li><a href="home.cyt" >more..</a>.</li>
	                              </ul>
	                  	</div>
	               	</div>   			
	         	</div>
        ...
        <fieldset>
            <table id="groupList" border="0" cellpadding="0" cellspacing="0">
                <tbody>                        
                    <tr>
                        <td></td>
                        <td><input name="grpName" id="grp1" type="checkbox" value="Work Coleagues" /></td>
                        <td><span class="groupListFont">Remi's Work Colleagues </span></td>
                        <td></td>
                    </tr>							       		
                    <tr>
                        <td></td>
                        <td><input name="grpName" id="grp2" type="checkbox" value="Arsenal Football Team" /></td>
                        <td><span class="groupListFont">Timi's Football Team</span></td>
                        <td></td>
                    </tr>						       		
                    <tr>
                        <td></td>
                        <td><input name="grpName" id="grp3" type="checkbox" value="Media Team Church Members" /></td>
                        <td><span class="groupListFont">Joe's Church Members</span></td>
                        <td></td>
                    </tr>						       		
                    <tr>
                        <td></td>
                        <td><input name="grpName" id="grp4" type="checkbox" value="School Friends" /></td>
                        <td><span class="groupListFont">Dele's School Friends</span></td>
                        <td></td>
                    </tr>						       		
                </tbody> 
                 <tfoot>
