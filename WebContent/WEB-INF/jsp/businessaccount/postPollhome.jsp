				...
				<div id="main_content">
					...
					<div style="width: 100%; float: left;margin-top: -50px;">
					    ...
					    <div class="grid_17">
					    	...
					    	<div id="preview_poll_inner" style=" width: 97%; float: left; border-bottom: 10px #aeaead solid;border-top:5px #aeaead solid;">
					    		 <c:forEach var="chart" items="${chart}" varStatus="status">
 									<div class="incomming_incyyte_detail" style=" width: 97%; float: left; border-bottom: 5px #aeaead solid;border-top:5px #aeaead solid;" >
