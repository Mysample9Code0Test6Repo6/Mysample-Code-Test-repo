    ...
    <div id="leftPane">   
   	...
   	<div class="centerPane">        
        ...
        <div class="cpView">    
        		<center>
        		<br/><br/><br/><br/><br/><br/>
        		<form:form  id="searchForm" modelAttribute="searchCriterion" method="post" >  
        			Search By Post Code:&nbsp;<form:input path="searchCriterion"/><input type="submit" value="Search" /> </br>
        			<c:if test="${ noGrpMsg eq true}" scope="request" var="noGrpMsg">
        				<c:out value="No Groups found"></c:out>
        			</c:if>
        			<c:if test="${ noGrpMsg eq false}" scope="request" var="noGrpMsg">
        				<c:out value="Group found for search criterion::" /></br>
        			</c:if>
        			
        			<c:forEach var="group" items="${ userGroups}" varStatus="rowItem">
        				<c:out value="${rowItem.index + 1 }" />.&nbsp;&nbsp;&nbsp;&nbsp;
        				<c:out value="${group.groupName}"></c:out>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        			    <c:out value="${group.description}"></c:out><br/>
        			</c:forEach>
        			<br/><br/>
        		</form:form>
        ...
        <div class="portletBody">        
        			<div class="content">
	                 	<div id="profilePortlet">
	                 		<div class="card">
	                 			<div class="icon">
	                 				<img src="photo.htm" width="76px" height="72px"/>
	                 			</div>
	                 			<div class="label">
	                 				<c:choose>
            ...
            <table id="groupList" border="0" cellpadding="0" cellspacing="0">
                <tbody>                        
                    <tr>
                        ...
                        <td><span class="groupListFont">Work Coleagues </span></td>
                        <td></td>
                    </tr>							       		
                    <tr>
                        <td></td>
